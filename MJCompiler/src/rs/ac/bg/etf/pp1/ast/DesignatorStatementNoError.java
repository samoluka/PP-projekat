...
public class DesignatorStatementNoError extends DesignatorStatement {

    private Designator Designator;
    private DesignatorItem DesignatorItem;

    public DesignatorStatementNoError (Designator Designator, DesignatorItem DesignatorItem) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementNoError(\n");
