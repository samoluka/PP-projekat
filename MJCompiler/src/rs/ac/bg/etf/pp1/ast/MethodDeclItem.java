...
public class MethodDeclItem implements SyntaxNode {
    ...
    public MethodDeclItem (FormalParams FormalParams, VarDeclList VarDeclList, StatementList StatementList) {
