...
public class DesignatorWithParam extends Factor {

    private Designator Designator;
    private ActualPars ActualPars;

    public DesignatorWithParam (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorWithParam(\n");
